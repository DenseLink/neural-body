    ...
    while True:
        ...
        while degree < 10000:
            ...
            if view == 0:
                ...
                pygame.draw.circle(screen, (100, 50, 220), [x6, int(scr_height / 2)], 5)
                pygame.draw.circle(screen, (73, 155, 55), [x7, int(scr_height / 2)], 5)
                pygame.draw.circle(screen, (55, 75, 95), [x8, int(scr_height / 2)], 5)
            ...
            states = menu(screen, [pause, view, speed,0,0, click_now, input_active, textbox_active, input_text], scr_width, scr_height)
            pause = states[0]
            speed = states[2]
